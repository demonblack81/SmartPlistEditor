...
begin
   { 0. Проверяем на какой мы закладке 
     ...
     0.2. Если мы назакладке дерева проверяем что выбран ли элемент иначе выходим
     0.3. Ввыводим сообщение что фокус должен быть на одном из элементов

     1. Добавление параметра когда он первый в плисте
     1.1. Вызываем окно ввода названия параметра
     1.2. Если не введено название выходим и выводим сообщение что не введено название файла
     1.3. Если название введено то вызываем окно для ввода значения параметра
